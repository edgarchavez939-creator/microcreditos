...
class SolicitudResource extends JsonResource
{
    public function toArray($request): array
    {
        return [
            ...
            'cliente_salario'    => $this->whenLoaded('cliente', fn () => $this->cliente->salario !== null ? (float) $this->cliente->salario : null),
            'estado'             => $this->estado,
            'capital_solicitado' => (float) $this->capital_solicitado,
            'monto_aprobado'     => $this->monto_aprobado !== null ? (float) $this->monto_aprobado : null,
